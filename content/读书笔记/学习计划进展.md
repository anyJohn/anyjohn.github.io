...
（9 个维度加权平均：算法 60% + Python 50% + LangChain 20% + Agent 55% + React 5% + RAG升级 0% + 公司梳理 40% + 英语 25% + 面试 35%）
...
- ⏭️ 跳过 #32, #36, #42, #43, #47
- ✅ 转 LeetCode Hot 100
- ✅ LeetCode 完成 11/20 优先题（1, 49, 128, 283, 11, 15, 42, 53, 300, 198）
- ⏳ LeetCode Hot 100 优先 20 题进行中（11/20，下一题：完全平方数）
- 🔲 重点：DP、树
